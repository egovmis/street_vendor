...
public interface ULBMasterRepository extends CrudRepository<ULBMasterBean, Long>{
	 ...
	 * 
	 * @Query("FROM UserBean WHERE email = ? AND password= ?") public ULBMasterBean
	 * findByLogin(@Param("email") String email, @Param("password") String
	 * password);
	 */
}
